...
export default {
    ...
    return {
      educations: [
        {
          id: 1,
          name: "Yayasan Pendidikan Nurhasanah",
          require: "Sekolah Dasar (SD)",
          dstart: "2001",
          dend: "2006"
        },
        {
          id: 2,
          name: "Yayasan Pendidikan Ani Idrus",
          require: "Sekolah Menengah Pertama (SMP)",
          dstart: "2007",
          dend: "2010"
        },
        {
          id: 3,
          name: "Yayasan Adlin Murni",
          require: "Sekolah Menengah Atas (SMA)",
          dstart: "2010",
          dend: "2013"
        }
      ],
